...
All the codes are compiled with icc xxx and -O3 optimization.
...
%
  ...
  \caption{Bandwidth performance on the host under idealized
    ...
    intructions.  \todo{Can we label the x-axis "number of floats" or
...
to be performed in any order. The compiler can not use that
