...
Note that the ``permute'' function is using the {\tt
  \_mm512\_permute4f128\_epi32} instruction and therefore typecast are
necessary to convert to a vector of int type.
