...
%
  ...
  \caption{Estimation of the reachable performance one can achieve
    ...
    when varying the number of vectors and matrices. \todo{we could
      remove the speedup plot if we need space.}  \todo{can the legend
      read "Single Precision (best)"} \todo{there is a missing
      parenthesis in the title; alternatively remove title.}}
...
\subfigure[]{\includegraphics[clip=true,trim=4.5cm 11cm 4cm 4.2cm,width=.5\linewidth]{code.pdf}}%
\subfigure[]{\includegraphics[width=.5\linewidth]{figures/code-annote.pdf}}
