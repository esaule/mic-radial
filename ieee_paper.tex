...
case), releative to a potential speedup of 16. We have achieved a
speed 100 Gflops on 60 nodes using 240 threads, or a speed of 61\% of
maximum possible performance. The maximum possible speed for the 1/1
case is around 40 Gflops, of which we achieve 20 Gflops. On matrices
that exceed cache, a reverse Cuthill-McKee is applied to reduce the
bandwidth, with an associated speedup of 30\% up to 135 Gflops. Our
optimal implementation makes use of the AVX instruction set, which
...
implementation without AVX run at around 35 Gflops, or 16\% of peak
