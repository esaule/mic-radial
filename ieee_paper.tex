...
In Section~\ref{} we present the computation of RBFs and how it can be
expressed 16 multiplication of 4 vectors by 4 matrices. Section~\ref{}
presents an estimation of the instruction intensity of various form of
the computations and we show that a 5- to 6- fold improvement can be
...
possible. We describe in Section~\ref{} the details of the MIC
...
registers to be processed. Section~\ref{} gives some experimental
result about the amount of bandwidth that can be achieved depending on
how the spmv kernel is written and the actual performance of the
various kernel on multiple classes of matrices some generated for
analysis purpose and some extracted from and RBF
application. Concluding remarks and perspectives are provided in
Section~\ref{}.
