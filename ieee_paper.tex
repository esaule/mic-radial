...
In this paper, we propose yet a new idea that is applicable to radial
...
derived \cite{TAI1,TAI2,SDY02,WrFo06,FoL11,FLBWSC12}. RBF-FD use only
...
RBF-FD differentiation matrix $D_{n_z}$, resulting in a $N \ times N$
...
%
  ...
  \subfigure[The greater
    ...
    is aligned on 64
    bytes.]{\includegraphics[width=.40\linewidth]{figures/test3_gather.pdf}\label{fig:band_gather_ivdep}}
%
  \subfigure[
...
\begin{figure*}
\centering
\subfigure[No cache effects.]{\includegraphics[width=.33\linewidth]{figures/flops_to_bytes_no_cache-crop.pdf}}%\label{fig:ratio_nocache}}
