...
\begin{figure*}
  ...
  \subfigure[Performance of $y=Ax$ on the MIC. Squares: base 1/1 case],
    ...
    {\includegraphics[width=.49\linewidth]{figures/mic_performance_nb_threads.pdf}\label{fig:perf_mic}}
%
  \subfigure[performance on the host on a sparse matrix with $64^3$ rows. Manual
    ...
    well.]{\includegraphics[width=.49\linewidth]{figures/64x64x64.pdf}\label{fig:perf_host}}
