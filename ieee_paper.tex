...
approximatively 10\% of the available flop/s of a Xeon Phi
...
remarks and perspectives are provided in Section~\ref{sec:ccl}.\looseness=-1
...
the memory controller. Its precise bandwidth 
...
In a future work, we will examine the effect of larger stencil sizes, double precision and port common techniques from SpMV. We will also integrate the techniques
