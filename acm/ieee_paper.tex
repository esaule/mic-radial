...
\begin{figure}[t]
  ...
  \caption{Performance of $y=Ax$ for a RBF derivative stencil of a
    ...
    vectorized code.
    We also show peak theoretical performance for the base case and the 4 vector/1 matrix case. Not shown is the peak theoretical performance of 210 Gflops for the 4/4 case. 
    }
