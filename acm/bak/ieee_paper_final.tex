...
%\subfigure[Content of the vector registers {in the source code}.]{\hspace{0.07\linewidth}\includegraphics[width=.55\linewidth]{figures/code-annote.pdf}}
...
% Figure 9
  \centering
% was width=.48
  \subfigure[Supercompact and Random.]{\includegraphics[width=.4\linewidth]{figures/random_supercompact.pdf}\label{fig:perf_ideal}}
% was width=.48
  \subfigure[Compact and RBFFD.]{\includegraphics[width=.4\linewidth]{figures/rbf_compact.pdf}\label{fig:perf_realistic}}
