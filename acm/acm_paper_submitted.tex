...
Finite-Difference (RBF-FD). RBF methods express functions as a linear
...
\begin{figure}[t]
\centering
\includegraphics[width=0.80\linewidth]{figures/RBFStencil_n32_a.pdf}\label{fig:stencil}
...
\begin{figure*}[tbh]
  \centering
  \subfigure[Best case.]{\includegraphics[width=.31\linewidth]{figures/flops_to_bytes_best-crop.pdf}\label{fig:ratio_best}}%
  \subfigure[Worst case.]{\includegraphics[width=.31\linewidth]{figures/flops_to_bytes_worst-crop.pdf}\label{fig:ratio_worst}}%
  \subfigure[Worst case (No cacheline effects)]{\includegraphics[width=.31\linewidth]{figures/flops_to_bytes_no_cache-crop.pdf}\label{fig:ratio_worst_nocache}}
...
\begin{figure}[t]
  \centering 
  \includegraphics[width=.95\linewidth]{figures/gflops_peak.pdf}\label{fig:gflops-peak-perf}
...
\subfigure[Content of the vector registers.]{\hspace{0.07\linewidth}\includegraphics[width=.55\linewidth]{figures/code-annote.pdf}}
%%\subfigure[Content of the vector registers \ge{in the source code}.]{\hspace{-0.07\linewidth}\includegraphics[width=.55\linewidth]{figures/code-annote.pdf}}
}
...
\ee{The model of Section~\ref{sec:model} establishes that the 
  memory
...
RBF-FD calculations (Figure~\ref{fig:rbf3dnorcm} shows a $32$-point
...
85~GB/s. Using cache lines of 512 bits, we find a best/worst speeds of 2.4/20\; Gflops/s and 
32/120\; Gflops/s, respectively for the 1vec/1mat and 4vec/4mat cases. 
Our implementation on Cascade reaches 45 Gflops for the 4/4\, case, or 45/120=37\% of peak theoretical 
performance on this particular processor setup. For reference, we achieve 
...
The gain in the 4/4 case with respect to 4x 1/1 case is 4x on the MIC 
and 2.5x on the front end, respectively.  
}

% cascade
%[  2.35701906   8.04733728   9.37931034  31.62790698  36.75675676]
%[  20.60606061   32.96969697   75.55555556  120.88888889  226.66666667]
...
RBF-FD. Each derivative has an associated sparse matrix with a fixed
...
best case practical 1/1 implementation.
...
RBF-FD. \ge{We will also look into developing a similar technique on the Kepler
family of GPUs, which offers swizzling and channeling operations.}

\section*{Acknowledgment}
Erlebacher was supported under NSF grant
