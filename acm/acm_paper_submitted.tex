...
\begin{figure}[t]
\centering
\includegraphics[width=0.60\linewidth]{figures/RBFStencil_n32_a.pdf}\label{fig:stencil}
...
\begin{figure*}[tbh]
  \centering
  \subfigure[Best case.]{\includegraphics[width=.28\linewidth]{figures/flops_to_bytes_best-crop.pdf}\label{fig:ratio_best}}%
  \subfigure[Worst case.]{\includegraphics[width=.28\linewidth]{figures/flops_to_bytes_worst-crop.pdf}\label{fig:ratio_worst}}%
  \subfigure[Worst case (No cacheline effects)]{\includegraphics[width=.28\linewidth]{figures/flops_to_bytes_no_cache-crop.pdf}\label{fig:ratio_worst_nocache}}
...
% Figure 9
  \centering
% was width=.48
  \subfigure[Supercompact and Random.]{\includegraphics[width=.35\linewidth]{figures/random_supercompact.pdf}\label{fig:perf_ideal}}
% was width=.48
  \subfigure[Compact and RBF-FD.]{\includegraphics[width=.35\linewidth]{figures/rbf_compact.pdf}\label{fig:perf_realistic}}
...
% Figure 10
  ...
  \includegraphics[width=.8\linewidth]{figures/mic_performance_nb_threads.pdf}
